...
// 0xf6, 0xf7: Group 3 instructions
make_group(gp3,
...
opcode_entry opcode_table [512] = {
  ...
  /* 0xa4 */    EX(movsb), EX(movsd), EMPTY, EMPTY,
  ...
  /* 0x00 */	EMPTY, IDEXW(E, Group7, 0),EMPTY, EMPTY,
  ...
  /* 0xbc */	EMPTY, IDEX(E2G, bsr), IDEXW(E2G, movzx, 1), IDEXW(E2G, movzx, 2),
