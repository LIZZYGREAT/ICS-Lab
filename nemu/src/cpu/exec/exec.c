...
opcode_entry opcode_table [512] = {
  ...
  /* 0x90 */	EX(nop),  IDEX(r2a, xchg), IDEX(r2a, xchg), IDEX(r2a, xchg),
  /* 0x94 */	IDEX(r2a, xchg), IDEX(r2a, xchg), IDEX(r2a, xchg), IDEX(r2a, xchg),
  ...
  /* 0x20 */	IDEX(cr2r, mov), EMPTY, IDEX(r2cr, mov), EMPTY,
